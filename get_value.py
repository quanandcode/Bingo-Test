...
def bind_all(nums):
    def value00(event): 
        value = nums[0][0]['text']
        print(value)
        # call check function every time key click
        if (kiem_tra_bingo.check(0, 0) == True):
    ...
    def value01(event):
        value = nums[0][1]['text']
        print(value)
        if (kiem_tra_bingo.check(0, 1) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[0][1]['fg'] = "#123"
    ...
    def value02(event):
        value = nums[0][2]['text']
        print(value)
        if (kiem_tra_bingo.check(0, 2) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[0][2]['fg'] = "#123"
    ...
    def value03(event):
        value = nums[0][3]['text']
        print(value)
        if (kiem_tra_bingo.check(0, 3) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[0][3]['fg'] = "#123"
    ...
    def value04(event):
        value = nums[0][4]['text']
        print(value)
        if (kiem_tra_bingo.check(0, 4) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[0][4]['fg'] = "#123"
    ...
    def value10(event):
        value = nums[1][0]['text']
        print(value)
        if (kiem_tra_bingo.check(1, 0) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[1][0]['fg'] = "#123"
    ...
    def value11(event):
        value = nums[1][1]['text']
        print(value)
        if (kiem_tra_bingo.check(1, 1) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[1][1]['fg'] = "#123"
    ...
    def value12(event):
        value = nums[1][2]['text']
        print(value)
        if (kiem_tra_bingo.check(1, 2) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[1][2]['fg'] = "#123"
    ...
    def value13(event):
        value = nums[1][3]['text']
        print(value)
        if (kiem_tra_bingo.check(1, 3) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[1][3]['fg'] = "#123"
    ...
    def value14(event):
        value = nums[1][4]['text']
        print(value)
        if (kiem_tra_bingo.check(1, 4) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[1][4]['fg'] = "#123"
    ...
    def value20(event):
        value = nums[2][0]['text']
        print(value)
        if (kiem_tra_bingo.check(2, 0) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[2][0]['fg'] = "#123"
    ...
    def value21(event):
        value = nums[2][1]['text']
        print(value)
        if (kiem_tra_bingo.check(2, 1) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[2][1]['fg'] = "#123"
    ...
    def value22(event):
        value = nums[2][2]['text']
        print(value)
        if (kiem_tra_bingo.check(2, 2) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[2][2]['fg'] = "#123"
    ...
    def value23(event):
        value = nums[2][3]['text']
        print(value)
        if (kiem_tra_bingo.check(2, 3) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[2][3]['fg'] = "#123"
    ...
    def value24(event):
        value = nums[2][4]['text']
        print(value)
        if (kiem_tra_bingo.check(2, 4) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[2][4]['fg'] = "#123"
    ...
    def value30(event):
        value = nums[3][0]['text']
        print(value)
        if (kiem_tra_bingo.check(3, 0) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[3][0]['fg'] = "#123"
    ...
    def value31(event):
        value = nums[3][1]['text']
        print(value)
        if (kiem_tra_bingo.check(3, 1) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[3][1]['fg'] = "#123"
    ...
    def value32(event):
        value = nums[3][2]['text']
        print(value)
        if (kiem_tra_bingo.check(3, 2) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[3][2]['fg'] = "#123"
    ...
    def value33(event):
        value = nums[3][3]['text']
        print(value)
        if (kiem_tra_bingo.check(3, 3) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[3][3]['fg'] = "#123"
    ...
    def value34(event):
        value = nums[3][4]['text']
        print(value)
        if (kiem_tra_bingo.check(3, 4) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[3][4]['fg'] = "#123"
    ...
    def value40(event):
        value = nums[4][0]['text']
        print(value)
        if (kiem_tra_bingo.check(4, 0) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[4][0]['fg'] = "#123"
    ...
    def value41(event):
        value = nums[4][1]['text']
        print(value)
        if (kiem_tra_bingo.check(4, 1) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[4][1]['fg'] = "#123"
    ...
    def value42(event):
        value = nums[4][2]['text']
        print(value)
        if (kiem_tra_bingo.check(4, 2) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[4][2]['fg'] = "#123"
    ...
    def value43(event):
        value = nums[4][3]['text']
        print(value)
        if (kiem_tra_bingo.check(4, 3) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[4][3]['fg'] = "#123"
    ...
    def value44(event):
        value = nums[4][4]['text']
        print(value)
        if (kiem_tra_bingo.check(4, 4) == True):
            messagebox.showinfo("You win!", "congratulations")
        nums[4][4]['fg'] = "#123"
